...
API_ID = 28626494
API_HASH = 'bf0ca98a85bf45bcabd5c5c3b29f9546'
PHONE = "+2348039450649"

# Persistent session
SESSION_NAME = "new_session_39"  # Change this to a fixed session name
...
def add_members_to_group(group_username):
    with TelegramClient(SESSION_NAME, API_ID, API_HASH) as client:
        try:
            ...
            with open("members39.csv", "r", encoding="utf-8") as file:
