...
API_ID = 23176702
API_HASH = 'ccfa37fe0a74bb716f1959a95aab4ea4'
PHONE = "+2349031364946"

# Persistent session
SESSION_NAME = "new_session_37"  # Change this to a fixed session name
...
def add_members_to_group(group_username):
    with TelegramClient(SESSION_NAME, API_ID, API_HASH) as client:
        try:
            ...
            with open("members37.csv", "r", encoding="utf-8") as file:
