...
API_ID = 20805183
API_HASH = 'ebaa80e50addaacb393de539d83c7d5a'
PHONE = "+2349031326684"

# Persistent session
SESSION_NAME = "new_session_36"  # Change this to a fixed session name
...
def add_members_to_group(group_username):
    with TelegramClient(SESSION_NAME, API_ID, API_HASH) as client:
        try:
            ...
            with open("members36.csv", "r", encoding="utf-8") as file:
