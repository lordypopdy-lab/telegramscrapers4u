...
API_ID = 21731681
API_HASH = 'e03c4f02927e6dd26d91d023d7def6dd'
PHONE = "+2348133687380"

# Persistent session
SESSION_NAME = "new_session_31"  # Change this to a fixed session name
...
def add_members_to_group(group_username):
    with TelegramClient(SESSION_NAME, API_ID, API_HASH) as client:
        try:
            ...
            with open("members31.csv", "r", encoding="utf-8") as file:
