...
API_ID = 21940552
API_HASH = 'd8a4059bd2ccce9dcce9ac76a1bb5b27'
PHONE = "+2349031375105"

# Persistent session
SESSION_NAME = "new_session_38"  # Change this to a fixed session name
...
def add_members_to_group(group_username):
    with TelegramClient(SESSION_NAME, API_ID, API_HASH) as client:
        try:
            ...
            with open("members38.csv", "r", encoding="utf-8") as file:
