...
API_ID = 24339408
API_HASH = '673d7f4766e7bddf72d45709397bdddf'
PHONE = "+2349031246256"

# Persistent session
SESSION_NAME = "new_session_42"  # Change this to a fixed session name
...
def add_members_to_group(group_username):
    with TelegramClient(SESSION_NAME, API_ID, API_HASH) as client:
        try:
            ...
            with open("members42.csv", "r", encoding="utf-8") as file:
