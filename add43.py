...
API_ID = 26991246
API_HASH = '88970586efe3838d2ad0c06732049189'
PHONE = "+2349031318159"

# Persistent session
SESSION_NAME = "new_session_43"  # Change this to a fixed session name
...
def add_members_to_group(group_username):
    with TelegramClient(SESSION_NAME, API_ID, API_HASH) as client:
        try:
            ...
            with open("members43.csv", "r", encoding="utf-8") as file:
