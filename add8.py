...
# # Persistent session
# SESSION_NAME = "new_session_8"  # Change this to a fixed session name
...
#             with open("members8.csv", "r", encoding="utf-8") as file:
...
API_ID = 20306541
API_HASH = 'da7c1082b65503ec2f9160d732e352f9'
SESSION_NAME = "new_session_1"  # Persistent session
...
def dm_users():
    with TelegramClient(SESSION_NAME, API_ID, API_HASH) as client:
        with open("members1.csv", "r", encoding="utf-8") as file:
            csv_reader = csv.DictReader(file)
