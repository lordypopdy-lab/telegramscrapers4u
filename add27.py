...
API_ID = 20466203
API_HASH = '24fc2bb7058b5d93f182d089c1528fbe'
PHONE = "+2348146000772"

# Persistent session
SESSION_NAME = "new_session_27"  # Change this to a fixed session name
...
def add_members_to_group(group_username):
    with TelegramClient(SESSION_NAME, API_ID, API_HASH) as client:
        try:
            ...
            with open("members27.csv", "r", encoding="utf-8") as file:
