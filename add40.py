...
API_ID = 25874440
API_HASH = '25ccc266cc35712bb36d70ce18ab962c'
PHONE = "+2349030413181"

# Persistent session
SESSION_NAME = "new_session_40"  # Change this to a fixed session name
...
def add_members_to_group(group_username):
    with TelegramClient(SESSION_NAME, API_ID, API_HASH) as client:
        try:
            ...
            with open("members40.csv", "r", encoding="utf-8") as file:
