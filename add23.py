...
API_ID = 26514457
API_HASH = 'cf11715ff35d27748484b97c3ffc9b17'
PHONE = "+2347018283667"

# Persistent session
SESSION_NAME = "new_session_23"  # Change this to a fixed session name
...
def add_members_to_group(group_username):
    with TelegramClient(SESSION_NAME, API_ID, API_HASH) as client:
        try:
            ...
            with open("members23.csv", "r", encoding="utf-8") as file:
