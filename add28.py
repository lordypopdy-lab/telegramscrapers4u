...
API_ID = 24176778
API_HASH = '0a7837e781ec808b2faeaae94d27bc11'
PHONE = "+2349061473312"

# Persistent session
SESSION_NAME = "new_session_28"  # Change this to a fixed session name
...
def add_members_to_group(group_username):
    with TelegramClient(SESSION_NAME, API_ID, API_HASH) as client:
        try:
            ...
            with open("members28.csv", "r", encoding="utf-8") as file:
