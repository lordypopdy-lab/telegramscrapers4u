...
API_ID = 20366017
API_HASH = '4148f39809633453ac1f2cc6387d5139'
PHONE = "+2349123876422"

# Persistent session
SESSION_NAME = "new_session_32"  # Change this to a fixed session name
...
def add_members_to_group(group_username):
    with TelegramClient(SESSION_NAME, API_ID, API_HASH) as client:
        try:
            ...
            with open("members32.csv", "r", encoding="utf-8") as file:
...
if __name__ == "__main__":
    group_username = "@BitclubOfficialChat"  # Replace with your group username
