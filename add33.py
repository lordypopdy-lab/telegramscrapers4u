...
API_ID = 28270617
API_HASH = 'd79ffa54e598a16487eaf73bf7237dc8'
PHONE = "+2348130914589"

# Persistent session
SESSION_NAME = "new_session_33"  # Change this to a fixed session name
...
def add_members_to_group(group_username):
    with TelegramClient(SESSION_NAME, API_ID, API_HASH) as client:
        try:
            ...
            with open("members33.csv", "r", encoding="utf-8") as file:
