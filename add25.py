...
API_ID = 12482276
API_HASH = 'ed04801accd5e7c206b1ded63f8a7b82'
PHONE = "+2348162664392"

# Persistent session
SESSION_NAME = "new_session_25"  # Change this to a fixed session name
...
def add_members_to_group(group_username):
    with TelegramClient(SESSION_NAME, API_ID, API_HASH) as client:
        try:
            ...
            with open("members25.csv", "r", encoding="utf-8") as file:
