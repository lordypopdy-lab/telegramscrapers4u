...
API_ID = 23255998
API_HASH = '8af2437509d863a4e9f422f5b72689b0'
PHONE = "+2348124153206"

# Persistent session
SESSION_NAME = "new_session_24"  # Change this to a fixed session name
...
def add_members_to_group(group_username):
    with TelegramClient(SESSION_NAME, API_ID, API_HASH) as client:
        try:
            ...
            with open("members24.csv", "r", encoding="utf-8") as file:
