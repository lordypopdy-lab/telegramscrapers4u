...
API_ID = 27449784
API_HASH = 'e53f71263f3fcdffd9a46192b931cdf1'
PHONE = "+2348161817298"

# Persistent session
SESSION_NAME = "new_session_29"  # Change this to a fixed session name
...
def add_members_to_group(group_username):
    with TelegramClient(SESSION_NAME, API_ID, API_HASH) as client:
        try:
            ...
            with open("members29.csv", "r", encoding="utf-8") as file:
