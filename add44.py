...
API_ID = 24962333
API_HASH = '5d1f944d8e229e100f968eb79f4b2229'
PHONE = "+2349031429482"

# Persistent session
SESSION_NAME = "new_session_44"  # Change this to a fixed session name
...
def add_members_to_group(group_username):
    with TelegramClient(SESSION_NAME, API_ID, API_HASH) as client:
        try:
            ...
            with open("members44.csv", "r", encoding="utf-8") as file:
