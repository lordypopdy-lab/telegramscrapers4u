...
API_ID = 29736673
API_HASH = '5a48848ffcbc5cfcb18ecf2232d7bfa9'
PHONE = "+2347064668413"

# Persistent session
SESSION_NAME = "new_session_26"  # Change this to a fixed session name
...
def add_members_to_group(group_username):
    with TelegramClient(SESSION_NAME, API_ID, API_HASH) as client:
        try:
            ...
            with open("members26.csv", "r", encoding="utf-8") as file:
